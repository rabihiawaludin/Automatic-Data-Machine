									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body form">
												<form enctype="multipart/form-data" action="<?php echo site_url('admin/edit_berkas/'.$data->id_data); ?>" id="form" class="form-horizontal" method="POST">
												<div class="form-body">
													...
													<div class="form-group">
														...
														<div class="col-md-9">
															<select id="umum" name="umum" class="form-control" required>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="modal-footer">
													...
													<a href=<?php echo site_url('admin/hapus_berkas/'.$data->id_data); ?>><button type="submit" class="btn btn-danger">Hapus</button></a>
												</div>
											</div>
										</div>
									</div>
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h3 class="modal-title">Tambah Data Berkas</h3>
				</div>
				<div class="modal-body form">
					<form enctype="multipart/form-data" action="<?php echo site_url('admin/tambah_berkas'); ?>" id="form" class="form-horizontal" method="POST">
					<input type="hidden" value="" name="id"/> 
					<div class="form-body">
						<div class="form-group">
							<label class="control-label col-md-3">Nama Berkas</label>
							<div class="col-md-9">
							<input type="text" name="nama_file" class="form-control" placeholder="Nama berkas" required>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">Subjek Statistik</label>
						...
						<div class="form-group">
							<label class="control-label col-md-3">Kategori</label>
							<div class="col-md-9">
								<select id="khusus1" name="khusus" class="form-control" required>
									<?php foreach ($khusus as $data1){
										echo "<option value='$data1->id_khusus' class='$data1->id_umum'>$data1->kategori</option>";
									}?>
								</select>
							</div>
						</div>
