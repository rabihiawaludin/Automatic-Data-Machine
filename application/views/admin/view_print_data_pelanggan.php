  ...
  <div class="container">
    <div class="row">
      <div class="col col-sm-12">
        ...
        <h1 style="text-align:center;">Rekapitulasi Pelanggan Pengunjung ADM <br>
		...
		<?php $no = 1;?>
			<table width="100%">
				...
				<tr>
					...
					<td><?php echo $totalPNS?></td>
					<td><?php echo $totalPS?></td>
					<td><?php echo $totalWirausaha?></td>
					<td><?php echo $totalMP?></td>
				</tr>
			</table>
	</div>
</div>
