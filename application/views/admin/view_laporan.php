				...
				<div class="col-md-12">
					<div class="panel-body">
						...
						<div class="tab-content">
							...
							<?php echo form_open_multipart('admin/print_data_transaksi');?>
							...
							<?php echo form_open_multipart('admin/print_data_pelanggan');?>
								<div class="form-group">
									<label class="control-label col-md-2" id="nama">Pilih Bulan</label>
									<div class="col-md-2">
										<select class="form-control" name="bulan" >
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="panel panel-default">
											...
											<div class="panel-body">
												<?php echo form_open_multipart('admin/cek_ke_bulan');?>
												<div class="form-group">
													<label class="control-label col-md-2" id="nama">Pilih Bulan</label>
													<div class="col-md-2">
