...
<body>
						...
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody>
							 ...
							 foreach($data_petugas as $data){ 
								if(($data->jabatan!='Admin')&&($data->jabatan!='Pimpinan')){
							?>
							 <tr>
								...
								<div class="modal fade" id="myModal2<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<?php echo form_open_multipart('petugas/proses_edit_petugas');?>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="modal-footer">
													...
													<a href=<?php echo site_url('petugas/hapus_petugas/'.$data->nip); ?>><button type="submit" class="btn btn-danger">Hapus</button></a>
												</div>
											</div>
										</div>
									</div>
	...
	<?php echo form_open_multipart('petugas/proses_tambah_petugas');?>
		<div class="modal-dialog" role="form-control">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
